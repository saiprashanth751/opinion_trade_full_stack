                          ...
                          >
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-3">
                                <Badge className={`${order.type.includes('BUY')
                      ...
                      <div className="space-y-4">
                        {tradeHistory.map((trade, index) => (
                          <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: index * 0.1 }}
                            className={`bg-slate-800/30 backdrop-blur-sm border rounded-xl p-4 hover:bg-slate-700/30 transition-all duration-200 ${trade.buyerId === session?.user?.id
                          ...
                          >
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-3">
                                <Badge className={`${trade.buyerId === session?.user?.id
                                  ? "bg-green-500/20 text-green-300 border-green-500/30"
                                  : "bg-red-500/20 text-red-300 border-red-500/30"
                                  }`}>
